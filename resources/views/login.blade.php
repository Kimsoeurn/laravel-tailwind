    ...
    <header class="bg-purple-600 shadow-lg">
        <div class="container mx-auto px-6">
            <nav class="flex flex-col py-2 sm:flex-row sm:justify-between sm:items-center">
                <div>
                    <a href="#" class="text-2xl font-semibold text-white">Dev Geek</a>
                </div>
                <!-- Mobile Menu open: "block", Menu closed: "hidden" -->
                <div class="hidden -mx-4 md:flex md:items-center">
                    <a href="#" class="block mx-4 mt-2 md:mt-0 text-sm text-white capitalize hover:text-gray-900">Contact</a>
                    <a href="#" class="block mx-4 mt-2 md:mt-0 text-sm text-white capitalize hover:text-gray-900">About</a>
                </div>
            </nav>
        </div>
    </header>
    <div class="relative min-h-screen flex items-top justify-center bg-gray dark:bg-gray-900 sm:items-center sm:pt-0">
...
{{--                    <h2 class="text-4xl font-semibold text-gray-100">Dev Geek</h2>--}}
                    ...
                    <h3 class="text-2xl font-semibold text-gray-600">
                        Customer Credit and Payment <span class="text-red-400">System</span>
                    </h3>
                ...
                <div class="md:w-1/2 flex md:justify-end md:mt-0">
                    <div class="max-w-sm bg-gray-900 rounded-lg">
                        <div class="p-5">
...
{{--                                    <a href="#" class="text-gray-600 text-sm hover:underline">Forget Password?</a>--}}
                                    ...
                                    <button type="submit" class="px-4 py-2 font-semibold bg-green-600 rounded text-white hover:bg-green-900">Login</button>
                                </div>
                            </form>
                        </div>
                    </div>
